...
function isValid(formula){
    ...
    let formula1 = !(formula.includes(1) && formula.includes(2))
    let formula2 = !(formula.includes(3) && formula.includes(4))
    let formula3 = formula.includes(5) === formula.includes(6)
    let formula4 = formula.includes(7) || formula.includes(8)
