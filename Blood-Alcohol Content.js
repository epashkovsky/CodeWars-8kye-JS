...
Alcohol consumed will be passed as a drinks object with two properties: ounces (the total volume of 
beverage consumed in ounces), and abv (the % of alcohol by volume of the beverage as a floating 
point number--such as 0.05 for 5% abv beer or 0.4 for 40% abv whisky). For simplicity, Bob assures us 
that he drinks the same kind of beverage each time he drinks.
...
const bloodAlcoholContent = (drinks, weight, sex, time) => 
  Number((drinks.ounces * drinks.abv * 5.14 / weight * (sex === 'male' ? 0.73 : 0.66) - 0.015 * time).toFixed(4));